...
> # أو قم بتصدير المتغيرات في البيئة ثم شغّل:
> # export BOT_TOKEN="123456:ABC..."   # أو TELEGRAM_BOT_TOKEN
> # export CHAT_ID="987654"
> # ./run.sh
> # run.sh سيقرأ القيم من البيئة ويصدرها إلى العمليات الفرعية قبل التشغيل
> ```
>
> ⚠️ انتبه عند نسخ التوكن من المتصفح أو الوثائق: بعض المُحرّرات أو المواقع قد تُدرج شرطة غير عادية مثل “–” أو “‑” بدل “-”، أو قد تُدرج الشرطة أكثر من مرة (`---`).
> سيقوم السكربت الآن بتحويل هذه الشرطات ودمجها إلى شرطة مفردة تلقائياً، لكن إذا أردت تأكداً إضافياً فافحص التوكن واكتبه يدوياً.
>
> يمكنك تنظيف القيمة بنفسك باستخدام:
>
> ```bash
> # إزالة الفراغات، تحويل الشرطات الغريبة، ودمج المتكرر
> TELEGRAM_BOT_TOKEN=$(echo "$TELEGRAM_BOT_TOKEN" | tr '‑–—' '-' | sed 's/-\+/-/g')
> ```
>
